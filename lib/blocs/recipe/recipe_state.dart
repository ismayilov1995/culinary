...
class SuccessLoadChefsRecipes extends RecipeState {
  SuccessLoadChefsRecipes(this.recipeResponse);
...
class FailLoadChefsRecipes extends RecipeState {
  FailLoadChefsRecipes(this.error);
